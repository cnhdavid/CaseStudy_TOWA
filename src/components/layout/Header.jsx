  ...
  <div className="navbar-item">
    ...
    >
      ...
      <path
        ...
        strokeWidth="1"
      />
      <path d="M0.6628125 7.5h4.7860000000000005" stroke="#ffffff" strokeWidth="1" />
      <path d="M9.551187500000001 7.5h4.7860000000000005" stroke="#ffffff" strokeWidth="1" />
    </svg>
  </div>
);
  ...
  return (
    <header>
      ...
      >
        ...
        <div className={`navbar-menu has-background-danger ${isOpen ? "is-active" : ""}`}>
          <div className={`navbar-end has-text-centered ${styles.navItems}`}>
            {NAV_ITEMS.map((item) => (
              <a key={item.label} className="navbar-item has-text-white" href={item.href}>
                {item.label}
              </a>
            ))}
          </div>
